export const caseStudiesPageConfig = {
  hero: {
    title: "Case Studies",
    description: "Crafting user-centered experiences that drive business impact across fintech, e-commerce, and enterprise platforms."
  },
