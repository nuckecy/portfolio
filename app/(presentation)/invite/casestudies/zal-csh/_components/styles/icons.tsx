...
const makeLIcon = (paths: React.ReactNode) => makeIcon(paths, STYLE.icon.sizeL);
...
export const navIcons = {
  ...
  home: makeIcon(<><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></>, 16),
  exit: makeIcon(<><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></>, 16),
};
