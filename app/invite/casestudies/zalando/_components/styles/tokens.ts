...
export const STYLE = {
  ...
  type: {
    ...
    title2: { size: 42, weight: 300, lineHeight: 1.4, letterSpacing: '0', font: 'body' as const },
    title3: { size: 28, weight: 600, lineHeight: 1.3, letterSpacing: '0', font: 'body' as const },

    // Headers (content slide headings)
    header1: { size: 64, weight: 700, lineHeight: 1.05, letterSpacing: '-1px', font: 'heading' as const },
    header2: { size: 32, weight: 700, lineHeight: 1.2, letterSpacing: '0', font: 'heading' as const },
    header3: { size: 160, weight: 700, lineHeight: 1.0, letterSpacing: '-2px', font: 'heading' as const },

    // Paragraphs (body text at different scales)
    paragraph1: { size: 32, weight: 300, lineHeight: 1.6, letterSpacing: '0', font: 'body' as const },
    paragraph2: { size: 24, weight: 300, lineHeight: 1.5, letterSpacing: '0', font: 'body' as const },
    paragraph3: { size: 24, weight: 400, lineHeight: 1.4, letterSpacing: '0', font: 'body' as const },

    // Specialized (data / UI elements)
    statLabel: { size: 36, weight: 300, lineHeight: 1.2, letterSpacing: '0', font: 'body' as const },
    emphasis: { size: 48, weight: 700, lineHeight: 1.2, letterSpacing: '0', font: 'heading' as const },
    tag: { size: 20, weight: 700, lineHeight: 1.2, letterSpacing: '2px', font: 'heading' as const, textTransform: 'uppercase' as const },
    subCaption: { size: 32, weight: 300, lineHeight: 1.3, letterSpacing: '0', font: 'body' as const },
  },
...
type TypeKey = keyof typeof STYLE.type;

// Style Helpers
export const typeStyle = (key: TypeKey, colorOverride?: string): React.CSSProperties => {
...
export const slidePadding: React.CSSProperties = {
